...
class Article extends Model
{
    ...
    */
    ...
    protected $fillable = ['slug', 'resume', 'title', 'content', 'image', 'thumbnail', 'status', 'author_id', 'category_id', 'featured', 'top', 'recommended', 'date', 'extras', 'published_at', 'expired_at'];
    // protected $hidden = [];
    // protected $dates = [];
    protected $casts = [
        'featured'  => 'boolean',
